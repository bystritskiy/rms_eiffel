...
extern EIF_TYPED_VALUE F974_7299(EIF_REFERENCE);
extern EIF_TYPED_VALUE F974_7300(EIF_REFERENCE);
extern EIF_TYPED_VALUE F974_7301(EIF_REFERENCE);
...
EIF_TYPED_VALUE F974_7299 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = *(EIF_REFERENCE *)(Current + RTWA(5155,Dtype(Current)));
	return r;
}


/* {DATE_TIME_VALUE}.time */
EIF_TYPED_VALUE F974_7300 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F974_7301 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 973, Current, 0, 0, 13430);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(973, Current, 13430);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTNHOOK(1,1);
	tr8_1 = *(EIF_REAL_64 *)(tr1 + RTVA(5120, "fractional_second", tr1));
