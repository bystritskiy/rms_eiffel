...
extern EIF_TYPED_VALUE F962_7178(EIF_REFERENCE);
extern EIF_TYPED_VALUE F962_7179(EIF_REFERENCE);
extern EIF_TYPED_VALUE F962_7180(EIF_REFERENCE);
extern EIF_TYPED_VALUE F962_7181(EIF_REFERENCE);
extern EIF_TYPED_VALUE F962_7182(EIF_REFERENCE);
extern EIF_TYPED_VALUE F962_7183(EIF_REFERENCE);
...
EIF_TYPED_VALUE F962_7178 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F962_7178,13323,RTMS_EX_H("English",7,257590376));
}

/* {DATE_TIME_TOOLS}.days_text */
RTOID (F962_7179)
EIF_TYPED_VALUE F962_7179 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 961, Current, 0, 0, 13323);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(961, Current, 13323);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {301,222,0xFFFF};
		EIF_TYPE typres0;
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 961, Current, 0, 0, 13324);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(961, Current, 13324);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000127, 0,0); /* Result */
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 961, Current, 0, 0, 13325);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(961, Current, 13325);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000127, 0,0); /* Result */
...
RTOID (F962_7182)
EIF_TYPED_VALUE F962_7182 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 961, Current, 0, 0, 13326);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(961, Current, 13326);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000127, 0,0); /* Result */
...
EIF_TYPED_VALUE F962_7183 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F962_7183,13328,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
{
	GTCX
	RTOTC (F962_7184,13329,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
{
	GTCX
	RTOTC (F962_7185,13330,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}

void EIF_Minit962 (void)
{
	GTCX
	RTOTS (7178,F962_7178)
	RTOTS (7179,F962_7179)
	RTOTS (7180,F962_7180)
	RTOTS (7181,F962_7181)
	RTOTS (7182,F962_7182)
	RTOTS (7183,F962_7183)
	RTOTS (7184,F962_7184)
	RTOTS (7185,F962_7185)
}
