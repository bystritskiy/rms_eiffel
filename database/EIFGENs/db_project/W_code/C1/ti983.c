...
extern void F983_7413(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F983_7414(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F983_7415(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F983_7416(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F983_7417(EIF_REFERENCE);
extern EIF_TYPED_VALUE F983_7418(EIF_REFERENCE);
...
extern EIF_TYPED_VALUE F983_7428(EIF_REFERENCE);
extern void F983_7429(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F983_7430(EIF_REFERENCE, EIF_TYPED_VALUE);
...
extern void F983_7435(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F983_7436(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F983_7437(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F983_7438(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F983_7439(EIF_REFERENCE);
extern EIF_TYPED_VALUE F983_7440(EIF_REFERENCE);
extern EIF_TYPED_VALUE F983_7441(EIF_REFERENCE);
extern EIF_TYPED_VALUE F983_7442(EIF_REFERENCE);
extern EIF_TYPED_VALUE F983_7443(EIF_REFERENCE);
extern void F983_7945(EIF_REFERENCE, int);
...
/* {TIME_DURATION}.make */
void F983_7413 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define arg3 arg3x.it_i4
	...
	RTEAA(l_feature_name, 982, Current, 0, 3, 13528);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(982, Current, 13528);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 5269, 0x10000000, 1); /* hour */
	*(EIF_INTEGER_32 *)(Current + RTWA(5269, dtype)) = (EIF_INTEGER_32) arg1;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 5268, 0x10000000, 1); /* minute */
	*(EIF_INTEGER_32 *)(Current + RTWA(5268, dtype)) = (EIF_INTEGER_32) arg2;
	RTHOOK(3);
	RTDBGAA(Current, dtype, 5267, 0x20000000, 1); /* fine_second */
	tr8_1 = (EIF_REAL_64) (arg3);
	*(EIF_REAL_64 *)(Current + RTWA(5267, dtype)) = (EIF_REAL_64) tr8_1;
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
		...
		ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5113, dtype))(Current)).it_i4);
...
void F983_7414 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define arg3 arg3x.it_r8
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(5268, dtype)) = (EIF_INTEGER_32) arg2;
	RTHOOK(3);
	RTDBGAA(Current, dtype, 5267, 0x20000000, 1); /* fine_second */
	*(EIF_REAL_64 *)(Current + RTWA(5267, dtype)) = (EIF_REAL_64) arg3;
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
		RTCT("hour_set", EX_POST);
		ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(5269, dtype));
		...
		tr8_1 = *(EIF_REAL_64 *)(Current + RTWA(5267, dtype));
...
void F983_7415 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(5269, dtype)) = (EIF_INTEGER_32) ti4_1;
	RTHOOK(3);
	RTDBGAA(Current, dtype, 5267, 0x20000000, 1); /* fine_second */
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(5269, dtype));
	...
	(*(EIF_REAL_64 *)(Current + RTWA(5267, dtype))) -= tr8_2;
	RTHOOK(4);
	RTDBGAA(Current, dtype, 5268, 0x10000000, 1); /* minute */
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5113, dtype))(Current)).it_i4);
	ui4_1 = ti4_1;
	ti4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5105, dtype))(Current)).it_i4);
	ui4_2 = ti4_2;
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(5102, dtype))(Current, ui4_1x, ui4_2x)).it_i4);
	*(EIF_INTEGER_32 *)(Current + RTWA(5268, dtype)) = (EIF_INTEGER_32) ti4_1;
	...
	if (RTAL & CK_ENSURE) {
		...
		ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5256, dtype))(Current)).it_i4);
		if ((EIF_BOOLEAN)(ti4_1 == arg1)) {
			RTCK;
		} else {
			RTCF;
...
void F983_7416 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 982, Current, 0, 1, 13531);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTHOOK(1);
	RTDBGAA(Current, dtype, 5267, 0x20000000, 1); /* fine_second */
	*(EIF_REAL_64 *)(Current + RTWA(5267, dtype)) = (EIF_REAL_64) arg1;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 5269, 0x10000000, 1); /* hour */
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5113, dtype))(Current)).it_i4);
	ui4_1 = ti4_1;
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(5268, dtype)) = (EIF_INTEGER_32) ti4_1;
	...
	if (RTAL & CK_ENSURE) {
		...
		tr8_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5255, dtype))(Current)).it_r8);
		...
		tr8_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5266, dtype))(Current)).it_r8);
...
EIF_TYPED_VALUE F983_7417 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 982, Current, 0, 0, 13532);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(982, Current, 13532);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x20000000, 1,0); /* Result */
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(5269, dtype));
	ti4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5106, dtype))(Current)).it_i4);
	ti4_3 = *(EIF_INTEGER_32 *)(Current + RTWA(5268, dtype));
	ti4_4 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5105, dtype))(Current)).it_i4);
	tr8_1 = (EIF_REAL_64) ((EIF_INTEGER_32) ((EIF_INTEGER_32) (ti4_1 * ti4_2) + (EIF_INTEGER_32) (ti4_3 * ti4_4)));
	Result = *(EIF_REAL_64 *)(Current + RTWA(5267, dtype));
...
EIF_TYPED_VALUE F983_7418 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 982, Current, 0, 0, 13533);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(982, Current, 13533);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
#define ui4_3 ui4_3x.it_i4
	...
	RTEAA(l_feature_name, 982, Current, 0, 0, 13534);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(982, Current, 13534);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F983_7422 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 982, Current, 0, 0, 13537);
	RTSA(Dtype(Current));
	RTSC;
	...
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
	tr8_1 = *(EIF_REAL_64 *)(Current + RTWA(5267, Dtype(Current)));
	ti4_1 = (EIF_INTEGER_32) tr8_1;
	Result = (EIF_INTEGER_32) ti4_1;
	RTVI(Current, RTAL);
	RTRS;
...
EIF_TYPED_VALUE F983_7423 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REAL64;
	r.it_r8 = *(EIF_REAL_64 *)(Current + RTWA(5267,Dtype(Current)));
	return r;
}
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 982, Current, 0, 1, 13540);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(982, Current, 13540);
	RTCC(arg1, 982, l_feature_name, 1, eif_new_type(982, 0x00),0);
	RTIV(Current, RTAL);
...
body:;
	...
	tr8_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5255, dtype))(Current)).it_r8);
	tr8_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5255, "fine_seconds_count", arg1))(arg1)).it_r8);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 982, Current, 0, 1, 13541);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F983_7427 (EIF_REFERENCE Current)
{
	...
	if ((EIF_BOOLEAN) (tr8_1 >= tr8_2)) {
		...
		tb3 = '\0';
		tr8_1 = *(EIF_REAL_64 *)(Current + RTWA(5267, dtype));
		ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5105, dtype))(Current)).it_i4);
...
EIF_TYPED_VALUE F983_7428 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 982, Current, 0, 0, 13543);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	tb1 = '\01';
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(5269, dtype));
	ti4_2 = *(EIF_INTEGER_32 *)(Current + RTWA(5268, dtype));
...
void F983_7429 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
void F983_7430 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
body:;
	if (RTAL & CK_ENSURE) {
		in_assertion = ~0;
		RTE_OT
		ti4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5113, dtype))(Current)).it_i4);
		ti4_1 = ti4_2;
		tr1 = NULL;
		RTE_O
		tr1 = RTLA;
	...
	*(EIF_REAL_64 *)(Current + RTWA(5267, dtype)) = (EIF_REAL_64) (EIF_REAL_64) (tr8_1 + arg1);
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 982, Current, 0, 1, 13547);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	RTHOOK(3);
	RTDBGAA(Current, dtype, 5268, 0x10000000, 1); /* minute */
	*(EIF_INTEGER_32 *)(Current + RTWA(5268, dtype)) = (EIF_INTEGER_32) arg1;
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
		RTCT("minute_set", EX_POST);
		ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(5268, dtype));
...
void F983_7435 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r8
	...
	RTHOOK(1);
	RTDBGAA(Current, dtype, 5267, 0x20000000, 1); /* fine_second */
	(*(EIF_REAL_64 *)(Current + RTWA(5267, dtype))) += arg1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 982, Current, 0, 1, 13551);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTHOOK(1);
	RTDBGAA(Current, dtype, 5268, 0x10000000, 1); /* minute */
	(*(EIF_INTEGER_32 *)(Current + RTWA(5268, dtype))) += arg1;
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
		RTCT("minute_set", EX_POST);
		ti4_2 = *(EIF_INTEGER_32 *)(Current + RTWA(5268, dtype));
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 982, Current, 0, 1, 13552);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if (RTAL & CK_ENSURE) {
		in_assertion = ~0;
		RTE_OT
		ti4_2 = *(EIF_INTEGER_32 *)(Current + RTWA(5269, dtype));
		ti4_1 = ti4_2;
		tr1 = NULL;
		RTE_O
		tr1 = RTLA;
	...
	RTHOOK(1);
	RTDBGAA(Current, dtype, 5269, 0x10000000, 1); /* hour */
	(*(EIF_INTEGER_32 *)(Current + RTWA(5269, dtype))) += arg1;
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
		RTCT("hour_set", EX_POST);
		ti4_2 = *(EIF_INTEGER_32 *)(Current + RTWA(5269, dtype));
...
/* {TIME_DURATION}.plus */
EIF_TYPED_VALUE F983_7438 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 982, Current, 0, 1, 13553);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	...
	tr1 = RTLNSMART(Dftype(Current));
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(5269, dtype));
	ti4_2 = *(EIF_INTEGER_32 *)(arg1 + RTVA(5269, "hour", arg1));
	ui4_1 = (EIF_INTEGER_32) (ti4_1 + ti4_2);
	ti4_3 = *(EIF_INTEGER_32 *)(Current + RTWA(5268, dtype));
	ti4_4 = *(EIF_INTEGER_32 *)(arg1 + RTVA(5268, "minute", arg1));
	ui4_2 = (EIF_INTEGER_32) (ti4_3 + ti4_4);
	tr8_1 = *(EIF_REAL_64 *)(Current + RTWA(5267, dtype));
	tr8_2 = *(EIF_REAL_64 *)(arg1 + RTVA(5267, "fine_second", arg1));
...
EIF_TYPED_VALUE F983_7439 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 982, Current, 0, 0, 13554);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define ur8_1 ur8_1x.it_r8
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5258, dtype))(Current)).it_b);
	if (tb1) {
		RTHOOK(2);
		RTDBGAL(Current, 0, 0xF80003D6, 0,0); /* Result */
	...
	if (RTAL & CK_ENSURE) {
		...
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5258, "canonical", Result))(Result)).it_b);
		if (tb1) {
			RTCK;
		} else {
			RTCF;
...
EIF_TYPED_VALUE F983_7441 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 982, Current, 0, 0, 13556);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(982, Current, 13556);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
	tr8_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5255, dtype))(Current)).it_r8);
	...
	*(EIF_REAL_64 *)tr1 = tr8_1;
	...
	ui4_1 = ti4_1;
	ti4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5107, dtype))(Current)).it_i4);
	ui4_2 = ti4_2;
...
EIF_TYPED_VALUE F983_7442 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 982, Current, 0, 0, 13557);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(982, Current, 13557);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80003D6, 0,0); /* Result */
	tr1 = RTLNSMART(Dftype(Current));
	...
	*(EIF_REAL_64 *)tr2 = tr8_1;
	...
	ui4_1 = ti4_1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWC(5253, Dtype(tr1)))(tr1, ui4_1x);
	RTNHOOK(1,2);
	Result = (EIF_REFERENCE) RTCCL(tr1);
	RTHOOK(2);
	tr8_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5255, dtype))(Current)).it_r8);
	tr8_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5255, dtype))(Current)).it_r8);
	RTNHOOK(2,1);
	tr1 = RTLN(eif_new_type(196, 0x00).id);
	*(EIF_REAL_64 *)tr1 = tr8_2;
	...
	tr8_2 = (EIF_REAL_64) (ti4_1);
	ur8_1 = (EIF_REAL_64) (tr8_1 - tr8_2);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(5260, "fine_second_add", Result))(Result, ur8_1x);
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
...
void F983_7945 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 982, Current, 0, 7944);
	RTSA(dtype);
	RTME(dtype, 0);
	RTIT("fractionals_large_enough", Current);
	tr8_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5257, dtype))(Current)).it_r8);
	...
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5113, dtype))(Current)).it_i4);
	tr8_1 = (EIF_REAL_64) (ti4_1);
	tr8_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5257, dtype))(Current)).it_r8);
