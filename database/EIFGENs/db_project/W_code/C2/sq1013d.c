...
static const EIF_TYPE_INDEX egt_0_1013 [] = {0xFF01,222,0xFFFF};
static const EIF_TYPE_INDEX egt_1_1013 [] = {0xFF01,239,1012,0xFFFF};
...
static const EIF_TYPE_INDEX egt_9_1013 [] = {0xFF01,222,0xFFFF};
static const EIF_TYPE_INDEX egt_10_1013 [] = {0xFF01,222,0xFFFF};
static const EIF_TYPE_INDEX egt_11_1013 [] = {0xFF01,15,0xFFFF};
static const EIF_TYPE_INDEX egt_12_1013 [] = {0xFF01,1012,0xFFFF};
static const EIF_TYPE_INDEX egt_13_1013 [] = {153,0xFFFF};
...
static const struct desc_info desc_1013[] = {
	...
	{EIF_NON_GENERIC(0x0133 /*153*/), 14055, 8},
	{EIF_NON_GENERIC(0x0183 /*193*/), 14067, 0xFFFFFFFF},
	{EIF_GENERIC(NULL), 14068, 0xFFFFFFFF},
	{EIF_GENERIC(egt_13_1013), 0x00, 0xFFFFFFFF},
};
void Init1013(void)
{
	IDSC(desc_1013, 0, 1012);
	IDSC(desc_1013 + 1, 1, 1012);
	IDSC(desc_1013 + 32, 384, 1012);
	IDSC(desc_1013 + 35, 360, 1012);
	IDSC(desc_1013 + 38, 382, 1012);
	IDSC(desc_1013 + 45, 365, 1012);
}
