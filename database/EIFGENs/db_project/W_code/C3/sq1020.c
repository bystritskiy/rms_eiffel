...
extern void F1020_7922(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1020_7923(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1020_7924(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1020_7925(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1020_7954(EIF_REFERENCE, int);
...
void F1020_7922 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1019, Current, 0, 2, 14053);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if (arg1) {
		RTCC(arg1, 1019, l_feature_name, 1, eif_new_type(220, 0x00), 0x00);
	}
	RTCC(arg2, 1019, l_feature_name, 2, RTWCT(5693, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		...
		ur1 = RTCCL(arg2);
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(5694, dtype))(Current, ur1x)).it_b);
		RTTE(tb1, label_1);
		RTCK;
		RTJB;
label_1:
...
body:;
	...
	*(EIF_REFERENCE *)(Current + RTWA(5692, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(6);
	RTDBGAA(Current, dtype, 5693, 0xF8000000, 0); /* value */
	RTAR(Current, arg2);
	*(EIF_REFERENCE *)(Current + RTWA(5693, dtype)) = (EIF_REFERENCE) RTCCL(arg2);
	if (RTAL & CK_ENSURE) {
		RTHOOK(7);
...
EIF_TYPED_VALUE F1020_7923 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F1020_7924 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F1020_7925 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 1019, Current, 0, 1, 14056);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1019, Current, 14056);
	RTCC(arg1, 1019, l_feature_name, 1, RTWCT(5693, Dtype(Current), Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1020_7954 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1019, Current, 0, 7953);
	RTSA(dtype);
	RTME(dtype, 0);
