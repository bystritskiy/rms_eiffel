...
extern void F1019_7922(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1019_7923(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1019_7924(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1019_7925(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1019_7954(EIF_REFERENCE, int);
...
void F1019_7922 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ur8_1 ur8_1x.it_r8
	...
	RTEAA(l_feature_name, 1018, Current, 0, 2, 14048);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1018, Current, 14048);
	if (arg1) {
		RTCC(arg1, 1018, l_feature_name, 1, eif_new_type(220, 0x00), 0x00);
	}
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		...
		ur8_1 = arg2;
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(5694, dtype))(Current, ur8_1x)).it_b);
		RTTE(tb1, label_1);
		RTCK;
		RTJB;
label_1:
...
body:;
	...
	*(EIF_REFERENCE *)(Current + RTWA(5692, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(6);
	RTDBGAA(Current, dtype, 5693, 0x20000000, 0); /* value */
	*(EIF_REAL_64 *)(Current + RTWA(5693, dtype)) = (EIF_REAL_64) arg2;
	if (RTAL & CK_ENSURE) {
		RTHOOK(7);
...
EIF_TYPED_VALUE F1019_7924 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REAL64;
	r.it_r8 = *(EIF_REAL_64 *)(Current + RTWA(5693,Dtype(Current)));
	return r;
}
...
#define arg1 arg1x.it_r8
	...
	RTEAA(l_feature_name, 1018, Current, 0, 1, 14051);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1018, Current, 14051);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1019_7954 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define ur8_1 ur8_1x.it_r8
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1018, Current, 0, 7953);
	RTSA(dtype);
	RTME(dtype, 0);
